...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-xwagl-y.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-xwagl-y.containers.anotherwebservice.com/
...
```
git clone git@github.com:saimasartej/container-xwagl-y.git
cd container-xwagl-y
```
...
```
docker attach container-xwagl-y
```
